        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <FormControl className={classes.formControl}>
                    <InputLabel id="demo-controlled-open-select-label">Кофешоп</InputLabel>
                    <Select
                        {...register("coffee_id", { required: 'Кофешоп не может быть пустым' })}
                ...
                <div>
                <FormControl className={classes.formControl}>
                    <InputLabel id="demo-controlled-open-select-label">Должность</InputLabel>
                    <Select
                        {...register("position_id", { required: 'Должность не может быть пустой' })}
                        labelId="demo-controlled-open-select-label"
                        id="position_id"
                        open={openPositionId}
